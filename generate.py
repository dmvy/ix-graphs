...
#                print d.get(arp_ip,'null')
	...
	'--vertical-label=bitspersecond',
        ...
        'DEF:inm=%s:in:MAX' % rrd_file,
        'DEF:outm=%s:out:MAX' % rrd_file,
        'CDEF:inb=in,8,*', 'CDEF:outb=out,8,*',
        'CDEF:inmb=inm,8,*', 'CDEF:outmb=outm,8,*',
        'AREA:inmb#00CF0066:inm ',
        'AREA:inb#00CF00FF:in ',
        'GPRINT:inb:LAST:cur\:%6.2lf%s',
        'GPRINT:inb:AVERAGE:avg\: %6.2lf%s',
        'GPRINT:inb:MAX:max\:%6.2lf%s\\n',
        'LINE:outmb#002A9766:outm',
        'LINE:outb#002A97FF:out',
        'GPRINT:outb:LAST:cur\:%6.2lf%s',
        'GPRINT:outb:AVERAGE:avg\: %6.2lf%s',
        'GPRINT:outb:MAX:max\:%6.2lf%s\\n'
                )
